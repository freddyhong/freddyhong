...
- Deep learning for **biomedical & genomic data**
- **3D computer vision** and segmentation (electron microscopy, medical imaging)
- Efficient **transformer architectures** and representation learning
- ML-driven engineering and scientific workflows

I am actively involved in **academic research** and teaching with plans to pursue **graduate study (MS/PhD) in ML-focused engineering or computational science**.
